package simpledb.test.lexer;

import java.io.*;

public class Lexerer {
    ...
    public static void main(String[] args) {
        ...
        Lexerer l = new Lexerer(new ByteArrayInputStream(expression.getBytes()));
        int s;
        while ((s = l.nextSymbol()) != Lexerer.EOF) {
            if (s != EOL) {
